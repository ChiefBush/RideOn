        ...
        <div className='h-screen absolute bottom-0 w-full flex flex-col justify-end'>
            <div className='h-[30%] p-6 bg-white relative'>
                ...
                <form onSubmit={(e)=>{submitHandler(e)}}>
                    <div className="absolute top-[42%] left-8"><i className="ri-record-circle-fill text-lg"></i></div>
                    <div className="line absolute h-12 w-0.5 top-[50%] left-10 bg-gray-900 rounded-full"></div>
                    <div className="absolute top-[70%] left-8"><i className="ri-stop-circle-fill text-lg"></i></div>
                    <input
